...
def test_LLM_no_trans(test_initial_state, test_goal_state, num_test, max_num_refine,
    ...
    # test loop
        ...
        for j in range(max_num_refine + 1):
            ...
            is_satisfied, is_error, error_message, error_action, error_type, error_action_idx, states, actions = scenario_simulator.simulate_actions(action_sequence, test_log_file_path)
            if print_states:
